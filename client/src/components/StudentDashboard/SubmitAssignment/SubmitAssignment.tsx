    ...
    return (
        <div className="container-fluid">
            <div className="row">
                <Sidebar />
                <div
                    className="col-md-10 m-auto shadow"
                    style={{ maxWidth: "700px" }}
                >
                    <h2
                        className="edu-burg-heading-1 text-center mb-5 mt-5"
                        style={{ fontSize: "45px" }}
                    >
                        {" "}
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="form-group mb-3">
                            <label
                                htmlFor="course-code"
                                className="edu-burg-input-label"
                            >
                                Enter Course Code
                            </label>
                            <input
                        ...
                        <button
                            type="submit"
                            className="btn brand-button text-white"
                        >
                            Submit
                        </button>
                    </form>
